...
<html>
	...
	function doEdit(id) {
		...
		if(oldPwd.value=="" || newPwd.value=="" || _newPwd.value==""){
			...
			alert("修改成功！");
			top.location.href='<%=basePath%>Student/updatePwd?id='+id+"&newPassword="+newPwd.value;
		}
	}
	</script>
					...
					<form method="post" action="">
						<table cellspacing="1" bgcolor="#c2d3b0">
							...
							<tr>
								...
								<td bgcolor="#FFFFFF">
									&nbsp;
									<input type="password" name="student.password" id="oldPwd" />
								</td>
								<td bgcolor="#FFFFFF">
									&nbsp;输入原始密码
								</td>
							...
							<tr>
								<td height="30" colspan="3" align="center" bgcolor="#FFFFFF">
									<input type="submit" value="修改" align="bottom"
										onclick="doEdit(${sessionScope.student.id});" />
									&nbsp;&nbsp;&nbsp;&nbsp;
